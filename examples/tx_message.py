...
class tx_message(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_message")
        ...
        self.qtgui_edit_box_msg_3 = qtgui.edit_box_msg(qtgui.DOUBLE, '125', 'attenuation_message', True, False, 'attenuation', None)
        ...
        self.qtgui_edit_box_msg_1 = qtgui.edit_box_msg(qtgui.DOUBLE, '10e6', 'sample_rate_message', True, False, 'rate', None)
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.DOUBLE, '1e9', 'frequency_message', True, False, 'lo_freq', None)
        ...
        self.msg_connect((self.qtgui_edit_box_msg_1, 'msg'), (self.sidekiq_sidekiq_tx_0, 'command'))
        self.msg_connect((self.qtgui_edit_box_msg_2, 'msg'), (self.sidekiq_sidekiq_tx_0, 'command'))
        self.msg_connect((self.qtgui_edit_box_msg_3, 'msg'), (self.sidekiq_sidekiq_tx_0, 'command'))
...
def main(top_block_cls=tx_message, options=None):
