...
class timestamp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sidekiq_sidekiq_rx_0 = sidekiq.sidekiq_rx(1, 0, 100, sample_rate, bandwidth, frequency, 1, gain_index, 2, 0)
        ...
        self.connect((self.sidekiq_sidekiq_rx_0, 0), (self.blocks_add_xx_0, 0))
