...
class transceive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.sidekiq_sidekiq_tx_0 = sidekiq.sidekiq_tx(0, 1, 0, samp_rate, (samp_rate * .8), frequency, 100, 0, 4, 4092, 0)
        self.sidekiq_sidekiq_rx_0 = sidekiq.sidekiq_rx(0, 1, 0, 100, samp_rate, (samp_rate * .8), frequency, 1, 1, 0, 0)
