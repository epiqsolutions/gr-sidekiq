...
import tag_print_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class tag_print(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "tag_print", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tag_print")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tag_print")
...
def main(top_block_cls=tag_print, options=None):
