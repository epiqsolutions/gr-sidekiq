...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.sidekiq_sidekiq_rx_0_0 = sidekiq.sidekiq_rx(sample_rate, 50, 1, center_freq, bandwidth, 1, vector_length, (),1)
        ...
        self.qtgui_freq_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, 0.0, 0, "rx_freq")
