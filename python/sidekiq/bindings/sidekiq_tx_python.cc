...
/* BINDTOOL_HEADER_FILE_HASH(81166fc0bddf39c1600c36f93b6fd980)                     */
/***********************************************************************************/
...
void bind_sidekiq_tx(py::module& m)
{
    ...
    py::class_<sidekiq_tx,
        ...
        .def("set_tx_sample_rate",
             &sidekiq_tx::set_tx_sample_rate,
             py::arg("value"),
             D(sidekiq_tx, set_tx_sample_rate))


        .def("set_tx_attenuation",
             &sidekiq_tx::set_tx_attenuation,
             py::arg("value"),
             D(sidekiq_tx, set_tx_attenuation))


        .def("set_tx_frequency",
             &sidekiq_tx::set_tx_frequency,
             py::arg("value"),
             D(sidekiq_tx, set_tx_frequency))


        .def("set_tx_bandwidth",
             &sidekiq_tx::set_tx_bandwidth,
             py::arg("value"),
